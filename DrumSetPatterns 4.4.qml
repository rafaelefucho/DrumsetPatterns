...
//=============================================================================
    ...
    MessageDialog
    {
        ...
        onAccepted: {
            // Modified: Replaced Qt.quit() with quit() for MuseScore 4+ compatibility
            quit()
        }
    }
...
//=============================================================================
    ...
    onRun:
    {
        ...
        {
            versionError.open()
            // Modified: Replaced (typeof(quit) === 'undefined' ? Qt.quit : quit)() with quit() for MuseScore 4+ compatibility
            quit()
            return;
        }
